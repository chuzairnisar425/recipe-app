            ...
            <div className="max-w-md mx-auto">
              ...
              <div className="divide-y divide-gray-200">
                <div className="py-8 text-base leading-6 space-y-4 text-gray-700 sm:text-lg sm:leading-7">
                  ...
                  <div className="relative">
                    <button className="bg-green-500 hover:bg-green-600 duration-500 text-white rounded-md px-2 py-1">Submit</button>
                  </div>
                  <div className='text-xs flex gap-2'>
                    <span>  Or</span>
                    <Link to='/login' className='text-green-500 hover:text-green-600 font-semibold'>Already have an account</Link>
                  </div>
